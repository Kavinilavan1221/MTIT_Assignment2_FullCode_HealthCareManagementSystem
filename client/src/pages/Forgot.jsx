...
import { Activity, Mail, ArrowRight, AlertCircle, CheckCircle2, ArrowLeft } from 'lucide-react';
...
export default function Forgot() {
  ...
  const handleForgot = async (e) => {
    ...
    setError('');
    try {
      await axios.post(`${GATEWAY_URL}/auth/forgot-password`, { email });
      setSuccess(true);
    } catch (err) {
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-500">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">We'll send you recovery instructions</p>
        </div>
        ...
        <div className="glass-card p-8">
          {success ? (
            <div className="text-center py-8">
              ...
              <p className="text-slate-400 mt-2 leading-relaxed">Please check your inbox at <br/><span className="text-sky-400 font-semibold">{email}</span></p>
              <Link to="/login" className="mt-8 inline-flex items-center gap-2 text-sky-500 font-bold hover:underline">
            ...
            <>
              ...
              <Link to="/login" className="mt-8 block text-center text-slate-500 hover:text-white transition-colors text-sm font-medium">
